  ...
  return (
    <footer className="relative">
      ...
      <motion.a
        ...
        style={{ background: "#25d366", boxShadow: "0 6px 20px rgba(37,211,102,0.5)" }}
        initial={{ scale: 0, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        transition={{ delay: 1.2, type: "spring", stiffness: 200 }}
        whileHover={{ scale: 1.12, boxShadow: "0 10px 30px rgba(37,211,102,0.6)" }}
        whileTap={{ scale: 0.92 }}
      >
        <WhatsAppIcon />
      </motion.a>
