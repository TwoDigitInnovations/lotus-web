...
import { projects, lotusssStats } from "@/data/siteData";
...
export async function getStaticProps({ params }) {
  const project = projects.find((p) => p.id === Number(params.id)) || null;
  ...
  return (
    <main className="bg-white">
      ...
      >
        ...
        {/* Project name + location bottom strip */}
        <motion.div
        ...
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-10">
              LOTUSSS has crafted 589 iconic projects across residential,
              non-residential and commercial, and contractual spaces, totalling
              152.69 million sq. ft. (14.18 million sq. m.)
            </p>
            <motion.div
